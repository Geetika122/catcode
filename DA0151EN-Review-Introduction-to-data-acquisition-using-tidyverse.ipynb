 ...
 "cells": [
   ...
   "outputs": [
    {
     ...
     "text": [
      "Warning message:\n",
      "“dependencies ‘dbplyr’, ‘googledrive’, ‘googlesheets4’, ‘haven’, ‘readr’, ‘readxl’, ‘reprex’, ‘stringr’, ‘tidyr’, ‘xml2’, ‘lifecycle’, ‘scales’ are not available”also installing the dependencies ‘systemfonts’, ‘textshaping’, ‘broom’, ‘dplyr’, ‘dtplyr’, ‘ggplot2’, ‘purrr’, ‘ragg’, ‘rvest’, ‘tibble’\n",
      "\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "ename": "ERROR",
     "evalue": "Error in head(sub_airline): object 'sub_airline' not found\n",
     "execution_count": 10,
     "output_type": "error",
     "traceback": [
  ...
  },
  {
   ...
   "outputs": [
    {
     "ename": "ERROR",
     "evalue": "Error in tail(sub_airline): object 'sub_airline' not found\n",
     "execution_count": 11,
     "output_type": "error",
     "traceback": [
      "Error in tail(sub_airline): object 'sub_airline' not found\nTraceback:\n",
      "1. tail(sub_airline)"
     ]
    }
   ],
  ...
  },
  {
   ...
   "outputs": [
    {
     "ename": "ERROR",
     "evalue": "Error in tail(sub_airline, 10): object 'sub_airline' not found\n",
     "execution_count": 12,
     "output_type": "error",
     "traceback": [
      "Error in tail(sub_airline, 10): object 'sub_airline' not found\nTraceback:\n",
      "1. tail(sub_airline, 10)"
     ]
    }
   ],
   "source": [
